// ============================================================================
// V2 PILOT — Big-science governance pair: BRAIN Initiative / EU Human Brain Project
// ============================================================================
//
// 108  BRAIN Initiative — distributed, working-group-driven governance that
//      survived but drifted from founding scope; contested public record.
//      EXERCISES THE COI RENDER PATH: an editor of this volume has research
//      adjacency to programs discussed in the case. Coi-block renders
//      gold-bordered "Disclosure" under the title.
// 109  EU Human Brain Project — top-down single-PI vision that unraveled.
//      EXERCISES THE EVIDENCE-FLAG RENDER PATH: largely journalism-sourced;
//      drafted as a contrast sidebar, not a standalone success/failure
//      narrative. evidence-flag: journalism-tier.
//
// Numbering placeholders (108, 109) pending editor decision A1.
