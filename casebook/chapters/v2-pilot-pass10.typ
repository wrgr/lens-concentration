// ============================================================================
// V2 PILOT — Pass 10: LE-literature gap-targeted candidates
// ============================================================================
//
//   190  In re 2U, Inc. Securities Class Action — disclosure-architecture
//        case under federal securities review. Investigation-grade.
//        coi-light (Katzman affiliation note).
//   191  Zhang/Scardamalia — Knowledge Building across three cohorts.
//        Peer-reviewed, JLS 2009; small-tier design study.
//   192  Chen et al. — Rural China AI devices and the equity-direction
//        finding. Peer-reviewed Frontiers in Psychology 2025; the
//        load-bearing hedges are carried in prose.
//
// Numbering placeholders (190–192) pending editor decision A1.
...
#case(
  ...
  summary: [
    ...
    anchored small-tier complement to v1 Case 42.
  ],
  sections: (
    [
