...
2. **All 77 v2 cases drafted — DONE** at v1 cadence. Files in `casebook/chapters/v2-pilot*.typ` (10 files: `v2-pilot.typ`, `v2-pilot-lending.typ`, `v2-pilot-race-construct.typ`, `v2-pilot-brain.typ`, `v2-pilot-governance.typ`, `v2-pilot-corporate-ld.typ`, `v2-pilot-pass3.typ`, `v2-pilot-pass4.typ`, `v2-pilot-pass1a.typ`, `v2-pilot-pass1b.typ`, `v2-pilot-pass2.typ`, `v2-pilot-mixed.typ`, `v2-pilot-suppl-a.typ`, `v2-pilot-suppl-b.typ`, `v2-pilot-suppl-c.typ`). Cases 101–177 contiguous. Numbering is placeholder pending editor decision A1 (Case 74 resolution → v2 numbering baseline).
3. **TODO — Wire pilot files into `casebook/book.typ`, `casebook/overview.typ`, `casebook/overview-half.typ`** so the three editions (print, digital, proof) and both overview formats include the v2 corpus. Pilots are deliberately separate until editor places them in their natural chapter homes; integration is a single pass once placement is decided.
4. **TODO — Source re-confirmation pass on flagged items** (per editor memo `v2_research/03_*`):
...
5. **TODO — First-person Practice Flywheel accounts** (2–3 for v2): authored by Will + Jim, not researched. CIRCUIT and ERKS-class efforts are natural sources. Paired with the front-matter "unpacking is the method" reframing.
6. **TODO — Case 74 PDF build issue.** Source intact at `casebook/chapters/ch05b-governance-extras.typ`; missing from latest PDF build — resolve before assigning v2 numbers.
