...
- **v2 drafting:** **in progress.** 23 cases drafted at v1 quality through June 2026 — TREWS (101), Epic Sepsis (102), Bartlett (103), Coots (104, preprint-tier), eGFR (105), pulse oximetry (106), Hoffman pain bias (107), BRAIN (108, COI), HBP (109, journalism-tier), OU Analyse (110), SyRI (111), Kirkpatrick (112, practice-synthesis-tier), Blume (113), SUBSAFE (114), California nurse ratios (115), Anesthesia monitoring + APSF (116), CIRAS (117), iPLEDGE (118), CIRCUIT/MICrONS (119, COI + internal-pm), CIRCUIT workforce (120, COI senior-author), Colorado CTSA team-science (121), IPE evidence gap (122), Implementation-science training (123). Pilot files live in `casebook/chapters/v2-pilot*.typ` and are not yet wired into `book.typ` — wiring happens in one pass once a critical mass of cases is accepted. **Remaining ~75 cases to be drafted in parallel via subagents** across pass-1 (124–139), pass-2 (140–149), JIGSAWS + non-US governance + Watson + Johnson (150–156), and pass-8 supplemental (157–177).
